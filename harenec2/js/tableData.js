...
$(document).ready(function () {
    ...
    document.getElementById("refresh-timetable-data").addEventListener("click", refreshTimetable);
    document.getElementById("choose-action-id").addEventListener("input", showEditForm);
    document.getElementById("choose-action-id2").addEventListener("input", showEditForm2);
